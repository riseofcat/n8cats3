...
import com.riseofcat.session.CodeSesServ;
...
private final CodeSesServ<Reader, String> server;
public SparkWebSocket(CodeSesServ<Reader, String> server) {
	this.server = server;
}
@OnWebSocketConnect
...
private static class SparkSes extends CodeSesServ.Ses<String> {
